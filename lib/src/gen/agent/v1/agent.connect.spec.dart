...
abstract final class AgentService {
  ...
  static const watchSession = connect.Spec(
    '/$name/WatchSession',
    connect.StreamType.server,
    agentv1agent.WatchSessionRequest.new,
  ...
  static const getAgentConfig = connect.Spec(
    '/$name/GetAgentConfig',
    connect.StreamType.unary,
    agentv1agent.GetAgentConfigRequest.new,
    agentv1agent.GetAgentConfigResponse.new,
  );
}
