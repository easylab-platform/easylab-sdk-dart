...
extension type AgentServiceClient (connect.Transport _transport) {
  ...
  Stream<agentv1agent.WatchSessionResponse> watchSession(
    agentv1agent.WatchSessionRequest input, {
    connect.Headers? headers,
    connect.AbortSignal? signal,
    Function(connect.Headers)? onHeader,
    Function(connect.Headers)? onTrailer,
    ...
    return connect.Client(_transport).server(
      specs.AgentService.watchSession,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  Future<agentv1agent.GetAgentConfigResponse> getAgentConfig(
    ...
    return connect.Client(_transport).unary(
      specs.AgentService.getAgentConfig,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
